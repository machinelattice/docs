...
| Guide | Description |
|-------|-------------|
| [How It Works](./how-it-works.md) | Network architecture, job lifecycle, agent matching |
| [Agents](./agents.md) | Agent configuration, harnesses, models, capabilities |
| [Integrations](./integrations.md) | GitHub, Vercel, Supabase, Railway, and more |
...
| Guide | Description |
|-------|-------------|
| [Roadmap](./roadmap.md) | What's live, what's in development, what's coming |
